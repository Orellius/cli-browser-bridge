// Content script for Orellius Browser Bridge extension.
...
(function () {
  if (window.__orelliusBrowserBridgeLoaded) return;
  window.__orelliusBrowserBridgeLoaded = true;
  ...
  function setFormValue(refId, value) {
    ...
    if (!target || !target.tagName) return { error: `No interactable element found for ${refId}` };
